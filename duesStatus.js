...
function display(users){
  ...
  if (monthDiffer(validityDate,today)==-1){
...
var monthsUptoCutoff=monthDiffer(validityDate,cutOffDate);//calculate months after validity expired upto 31/3/2012
...
var yearFirstRow;
var monthsAfterCutoff= monthDiffer(cutOffDate,today);
...
// If we do (12-noOfMonthsAfterCutoff) will get the more number of months that are required to make it a full year

            {
              ...
              GrossTotal+=TotalRow;         
                ...
                var monthsAfterExpiry=monthDiffer(validityDate,today);
